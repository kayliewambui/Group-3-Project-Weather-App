...
<Typography  ml={1} variant='h3'  >{`${prop.input.First_Name}  ${prop.input.Last_Name}`}</Typography>
      ...
      {/*this is where the headers end    */}
       ...
       {/* this is where the objective starts */}
      ...
      <Box sx={{ flexGrow: 1,boxShadow: 1  }}>
        <Grid container spacing={2} >
          ...
          <Grid xs={12} >
           ...
           {/* this is where the objective info Ends */}
                    {/* this is where work info begins */}
...
<Typography ml={4} variant='h6' align='left'><Typography component="span" fontWeight="bold">Time duration:</Typography>  {`${prop.input.Start_Date} to
          ...
          {/* this is where the work info Ends */}
 {/* this is where education info starts */}
          <Grid xs={12} >
          ...
          {/* this is where the education info Ends */} 
            {/* this is where the 'Key skills' info info starts */}
          ...
          {/* this is where the 'Key skills' info info Ends */}
